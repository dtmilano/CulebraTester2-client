...
class DefaultApi(object):
    ...
    def ui_device_wait_for_window_update_get(self, timeout, **kwargs):  # noqa: E501
        ...
        :param str package_name: the specified window package name (can be null). If null, a window update from any front-end window will end the wait
        :return: StatusResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def ui_object2_oid_get_text_get(self, oid, **kwargs):  # noqa: E501
        """Gets the text content if this object is an editable field.  # noqa: E501
    ...
    def ui_object2_oid_set_text_post(self, body, oid, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param Body body: Text to enter in the field (required)
        :param int oid: The object ID (required)
        :return: StatusResponse
                 If the method is called asynchronously,
                 returns the request thread.
