...
class DefaultApi(object):
    ...
    def ui_device_swipe_post(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ui_device_swipe_post(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.ui_device_swipe_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.ui_device_swipe_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def ui_device_swipe_post_with_http_info(self, **kwargs):  # noqa: E501
        """Performs a swipe between points in the Point array.  # noqa: E501

        Each step execution is throttled to 5ms per step. So for a 100 steps, the swipe will take about 1/2 second to complete  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ui_device_swipe_post_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def ui_object2_oid_set_text_post(self, body, oid, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param Body1 body: Text to enter in the field (required)
        :param int oid: The object ID (required)
        :return: StatusResponse
                 If the method is called asynchronously,
                 returns the request thread.
