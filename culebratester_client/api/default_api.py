...
class DefaultApi(object):
    ...
    def am_force_stop_get(self, pkg, **kwargs):  # noqa: E501
        """Completely stop the given application package.  # noqa: E501

        Completely stop the given application package.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.am_force_stop_get(pkg, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.am_force_stop_get_with_http_info(pkg, **kwargs)  # noqa: E501
        else:
            (data) = self.am_force_stop_get_with_http_info(pkg, **kwargs)  # noqa: E501
            return data

    def am_force_stop_get_with_http_info(self, pkg, **kwargs):  # noqa: E501
        """Completely stop the given application package.  # noqa: E501

        Completely stop the given application package.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.am_force_stop_get_with_http_info(pkg, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method am_force_stop_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('pkg' not in params or
                params['pkg'] is None):
            raise ValueError("Missing the required parameter `pkg` when calling `am_force_stop_get`")  # noqa: E501
    ...
    def ui_object_oid_get_bounds_get(self, oid, **kwargs):  # noqa: E501
        """Returns the view's bounds property.  # noqa: E501

        Returns the view's bounds property. See getVisibleBounds.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ui_object_oid_get_bounds_get(oid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.ui_object_oid_get_bounds_get_with_http_info(oid, **kwargs)  # noqa: E501
        else:
            (data) = self.ui_object_oid_get_bounds_get_with_http_info(oid, **kwargs)  # noqa: E501
            return data

    def ui_object_oid_get_bounds_get_with_http_info(self, oid, **kwargs):  # noqa: E501
        """Returns the view's bounds property.  # noqa: E501

        Returns the view's bounds property. See getVisibleBounds.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ui_object_oid_get_bounds_get_with_http_info(oid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method ui_object_oid_get_bounds_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'oid' is set
        if ('oid' not in params or
                params['oid'] is None):
            raise ValueError("Missing the required parameter `oid` when calling `ui_object_oid_get_bounds_get`")  # noqa: E501
    ...
    def ui_object_oid_get_child_get(self, oid, **kwargs):  # noqa: E501
        """The child  # noqa: E501

        Creates a new UiObject for a child view that is under the present UiObject.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ui_object_oid_get_child_get(oid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.ui_object_oid_get_child_get_with_http_info(oid, **kwargs)  # noqa: E501
        else:
            (data) = self.ui_object_oid_get_child_get_with_http_info(oid, **kwargs)  # noqa: E501
            return data

    def ui_object_oid_get_child_get_with_http_info(self, oid, **kwargs):  # noqa: E501
        """The child  # noqa: E501

        Creates a new UiObject for a child view that is under the present UiObject.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ui_object_oid_get_child_get_with_http_info(oid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method ui_object_oid_get_child_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'oid' is set
        if ('oid' not in params or
                params['oid'] is None):
            raise ValueError("Missing the required parameter `oid` when calling `ui_object_oid_get_child_get`")  # noqa: E501
