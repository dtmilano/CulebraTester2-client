...
class OidSetTextBody(object):
    ...
    def __init__(self, text=None):  # noqa: E501
        """OidSetTextBody - a model defined in Swagger"""  # noqa: E501
        self._text = None
    ...
    @property
    def text(self):
        """Gets the text of this OidSetTextBody.  # noqa: E501


        :return: The text of this OidSetTextBody.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this OidSetTextBody.


        :param text: The text of this OidSetTextBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OidSetTextBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OidSetTextBody):
            return False
