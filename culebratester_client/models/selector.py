...
class Selector(object):
    ...
    def __init__(self, checkable=None, checked=None, clazz=None, clickable=None, depth=None, desc=None, pkg=None, res=None, scrollable=None, text=None, index=None, instance=None):  # noqa: E501
